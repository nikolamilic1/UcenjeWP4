...
('žuta','2020-12-10','točkasta',7,1,'kratka',1);

--select * from neprijatelj;

insert into neprijatelj(majica,haljina,lipa,modelnaocala,kuna,jmbag,cura) values
('bijela','šarena',100.00,'Police',200.00,'01235231014',3),
('crna','dugačka',300.00,'XOX',900.00,'82310149876',2),
('žuta','kratka',700.00,'RayBan',9900.00,'99935231014',1);
